...
#### ユーティリティトークン
[YBM（Yabumi DAO Token）](https://doc.yabumi.xyz/readme/ybm-yabumi-dao-token)：未発行



# 3.punodwoɔ
[![punodwoɔ](/images/blog/pnd-banner.png)](https://pnd.defigeek.xyz/)
...
#### URL
  ...
  - punodwoɔの公式ドキュメントはこちら　[punodwoɔ公式ドキュメント](https://pnd-docs.defigeek.xyz/)
#### ユーティリティトークン
[PND（pnd DAO Token）](https://pnd-docs.defigeek.xyz/pnd-pnd-dao-token)：発行済み
...
# 4.Yamawake
[![Yamawake](/images/blog/yamawake-banner.png)](https://yamawake.xyz/)
...
#### URL
  - Yamawakeサービスサイトはこちら　 [Yamawake](https://yamawake.xyz/)
  - Yamawakeの公式ドキュメントはこちら　[Yamawake公式ドキュメント](https://docs.yamawake.xyz/)
#### ユーティリティトークン
[YMWK(Yamawake DAO Token)](https://docs.yamawake.xyz/readme/ymwk-yamawake-dao-token)：未発行


# 5.Megumi
[![Megumi](/images/blog/megumi-banner.png)](https://megumi.defigeek.xyz/)
Merkle Treeベースの汎用エアドロップツールです。エアドロップ主催者（Owner）は、対象者リスト（Merkle Tree）を作成し、Factory経由でエアドロップコントラクトをデプロイします。受取者（Claimer）は、自分のアドレスが対象に含まれている場合、Merkle Proof を用いてトークンをクレーム可能です。  
今後IAOを伴うMGMトークンローンチ予定です。  

#### URL
  - Megumiサービスサイトはこちら　 [Megumi](https://megumi.defigeek.xyz/)
  - Megumiの公式ドキュメントはこちら　Megumi公式ドキュメント(整備中)
#### ユーティリティトークン
MGM(Megumi DAO Token)：未発行
